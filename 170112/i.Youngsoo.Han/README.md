...
---
- 배경(출처 : http://opennet.or.kr/opentalk/2976)
 ...
 * 특히나 최근의 스마트폰 사용량 급증과 더불어서 이런 공인인증서 폴더의 해킹사례는 더욱 증가했는데, 개인 핸드폰이 PC보다 보안이 취약하다는 점과 APK 파일을 비롯한 외부 프로그램을 쉽게 설치할 수 있다는 점 때문에[23] [24] 공인인증서 폴더 탈취가 더욱 증가하고 있는 실정이다.
